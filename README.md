...
> **2026字节AI全栈挑战赛 · Agent智能体赛道**
> 
> 🎯 系统已经部署上线：**https://ci.jingzhi-ai.top**
>
> 📹 5分钟完整演示视频：
> ![演示视频](docs/demo.mp4)

基于 **LangGraph 12节点DAG编排 + 豆包大模型 + React全栈前端 + 飞书生态深度集成** 的企业级竞品情报分析SaaS平台。将传统人工2天的竞品分析工作压缩为AI **5分钟全自动完成**，质量评分稳定 **8.0+/10**。
...
| **核心价值** | 效率提升96%（2天→5分钟）、质量标准化（评分≥8.0/10）、业务落地性强 |
...
全赛道竞争强度可视化热力图，颜色越深代表对应优劣势更显著

### 8. 综合战力与胜率预测图
![综合战力与胜率](docs/images/综合战力与胜率及历史胜率波动图.png)
二维坐标轴展示我方产品和不同竞品的综合战力分布，自动计算对决胜率，所有预测数据来自数据分析。
