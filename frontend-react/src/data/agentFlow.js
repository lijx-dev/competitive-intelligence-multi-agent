/**
 * DAG 节点、模块与边定义 — 与后端 workflow.py 11 节点完全对应。
 */
...
export const dagNodes = [
  ...
  { id: 'survey',       label: '用户调研',  module: 'M1', icon: 'Users',       desc: '问卷设计与用户画像模拟' },
...
export const dagEdges = [
  ...
  { from: 'monitor', to: 'survey' },
  { from: 'research', to: 'fact_check' },
  { from: 'survey', to: 'fact_check' },
